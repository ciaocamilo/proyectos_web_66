...
export default {
    ...
    methods: {
        buscarCliente () {
            axios.get(`https://tienda-66-api.herokuapp.com/api/cliente/${this.cliente.identificacion}`)
            .then(response => {
        ...
        actualizarCliente () {
            axios.put(`https://tienda-66-api.herokuapp.com/api/actualizar-cliente/${this.cliente._id}`, this.cliente)
            .then(response => {
            ...
            this.$swal.fire({
                ...
                confirmButtonText: 'Sí, eliminar'
                    ...
                    if (result.isConfirmed) {
                        axios.delete(`https://tienda-66-api.herokuapp.com/api/eliminar-cliente/${this.cliente._id}`)
                            .then(response => {
                                let status_peticion = response.status
                                if (status_peticion === 200) {
                                    this.$swal.fire(
